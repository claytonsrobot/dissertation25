...
if True: # for disseration25
	from src.directories import Directories
	#sys.path.append('./imports/')

class Task1:
	sysexit = False
	use_project_import_dir = True
	use_project_export_dir = True
	df_override = True

def relevant_filelist():
	fl = [
		'mads4ptstats3235.csv',
		'cvptadstatsbyaq4551528.csv'
	   ]
	return fl

def run():
	"Build and adjust the mergeADs dataframe from the mads4ptstats3235.csv file"
	Directories.set_project_dir("task1")
	dict_columns = {"cvptad":"mads4ptstats3235.csv",
				 "cvlpmad":"mads4lpmstats3235.csv",
				 "MER":"mads4resstats32351823.csv",
				 "acvr":"mads4resstats32351823.csv",
				 "cvcvr":"mads4resstats32351823.csv",
				 "cver":"mads4resstats32351823.csv",
				 }
	for column_name,csv_filename in dict_columns.items():
		mergeADs = section1_mergeADs(column_name,csv_filename) 
	"""	
	if False:
		mergeADs_clbr,mergeADs_mrva = section2(mergeADs)
		section3(mergeADs,mergeADs_clbr)
		section4(mergeADs_mrva)
		section5(mergeADs)
		GWSgrp = section5G(mergeADs)
		section6_plotting(GWSgrp)	
		section7_plotting(GWSgrp)
		section8_plotting(GWSgrp)
		section9_plotting(GWSgrp)
	"""

def section1_mergeADs(column_name,csv_filename):
	...
	if Task1.use_project_import_dir:
		#mergeADs=pd.read_csv(Directories.get_import_dir()+'mads4ptstats3235.csv')
		mergeADs=pd.read_csv(Directories.get_import_dir()+csv_filename)
	else:
		#mergeADs=pd.read_csv('mads4ptstats3235.csv')
		mergeADs=pd.read_csv(csv_filename)
	...
	for name,group in gwsysgrp:#for name,group in lpmt_ddsitegrp:
		...
		#     #z=range(numrecs)
		#     # for y in z:
			x=statistics.median(group[column_name])
			meds.append(x)
			y=min(group[column_name])
			mins.append(y)
			a=max(group[column_name])
			maxes.append(a)
			b=np.mean(group[column_name])
			arithmeticmeans.append(b)
			c=statistics.stdev(group[column_name])
			stdevs.append(c)
			...
			iqrs.append(iqr)
			#print(x)
			#mrvamedianmeanagesbysite.concat([f'{group}:{statistics.median(group[column_name])}'])
		else:
			x=statistics.median(group[column_name])
			meds.append(x)
			y=min(group[column_name])
	...
	#medianmeanagesdf.to_csv(Directories.get_export_dir()+'cvptadstatsbyaq4551528.csv')
	medianmeanagesdf.to_csv(Directories.get_export_dir()+column_name+'statsbyaq4551528.csv')
	return mergeADs #medianmeanagesdf#,mergeADs_clbr
	######################################################for name,group in gwsysgrp:

def section2(mergeADs):
	...
	return mergeADs_mrva,mergeADs_clbr
	####################################################
	####################################################
	####################################################
def section3(mergeADs,mergeADs_clbr):
	...
	####################################################
	if Task1.df_override: # claytons df_override
		mergeADs_wlcx['cvptad'] = mergeADs_clbr['cvptad']
	...
	if Task1.sysexit is True: #clayton
		sys.exit()
def section4(mergeADs_mrva):
	####################################################
...
def section5(mergeADs):
	...
	if Task1.sysexit is True:
		sys.exit()
def section5G(mergeADs):
	####################################################
...
def section6_plotting(GWSgrp):
	...
	ax.legend()
	if Task1.use_project_export_dir:
		plt.savefig(os.path.join(Directories.get_export_dir(),'plots','cvPT_cvLPM_2175_byaq.png'))
	else:
	...
	ax.set_ylabel('Coefficient of variation of tracer age distribution')
	ax.legend()
	filename = 'acvr_cvLPM_2175_byaq.png'
	if Task1.use_project_export_dir:
		plt.savefig(os.path.join(Directories.get_export_dir(),'plots',filename))
	else:
	...
	ax.set_ylabel('Coefficient of variation of tracer age distribution')
	ax.legend()
	filename ='cVeR_cvLPM_2175_byaq.png'
	if Task1.use_project_export_dir:
		plt.savefig(os.path.join(Directories.get_export_dir(),'plots',filename))
	else:
		plt.savefig(os.path.join('plots',filename))
	...
	ax.set_ylabel('Coefficient of variation of tracer age distribution')
	ax.legend()
	filename = 'cVcVR_cvLPM_2175_byaq.png'
	if Task1.use_project_export_dir:
		plt.savefig(os.path.join(Directories.get_export_dir(),'plots',filename))
	else:
		plt.savefig(os.path.join('plots',filename))
	...
	ax.legend()
	filename = 'VRE_VPT_12184_byaq.png'
	if Task1.use_project_export_dir:
		plt.savefig(os.path.join(Directories.get_export_dir(),'plots',filename))
	else:
		plt.savefig(os.path.join('plots',filename))
	...
	ax.set_ylabel('Variance of particle tracking age distribution, years squared')
	ax.legend()
	filename = 'AVR_VPT_12184_byaq.png'
	if Task1.use_project_export_dir:
		plt.savefig(os.path.join(Directories.get_export_dir(),'plots',filename))
	else:
		plt.savefig(os.path.join('plots',filename))
	...
	ax.set_ylabel('Variance of particle tracking age distribution, years squared')
	ax.legend()
	filename = 'VVR_VPT_12184_byaq.png'
	if Task1.use_project_export_dir:
		plt.savefig(os.path.join(Directories.get_export_dir(),'plots',filename))
	else:
		plt.savefig(os.path.join('plots',filename))
...
def section7_plotting(GWSgrp):
	...
	ax.legend()
	filename = 'meanAgeWeightedAvg_vPT_12184_byaq.png'
	if Task1.use_project_export_dir:
		plt.savefig(os.path.join(Directories.get_export_dir(),'plots',filename))
	else:
		plt.savefig(os.path.join('plots',filename))
	...
	ax.set_xlabel('Mean of tracer age distribution, years')
	ax.legend()
	filename = 'LPMmeanage_vPT_12184_byaq.png'
	if Task1.use_project_export_dir:
		plt.savefig(os.path.join(Directories.get_export_dir(),'plots',filename))
	else:
		plt.savefig(os.path.join('plots',filename))
...
def section8_plotting(GWSgrp):
	...
	ax.legend()
	filename = 'VRE_vLPM_12184_byaq.png'
	if Task1.use_project_export_dir:
		plt.savefig(os.path.join(Directories.get_export_dir(),'plots',filename))
	else:
		plt.savefig(os.path.join('plots',filename))
	...
	ax.set_ylabel('Variance of tracer age distribution, years squared')
	ax.legend()
	filename = 'AVR_vLPM_12184_byaq.png'
	if Task1.use_project_export_dir:
		plt.savefig(os.path.join(Directories.get_export_dir(),'plots',filename))
	else:
		plt.savefig(os.path.join('plots',filename))
	...
	ax.set_ylabel('Variance of tracer age distribution, years squared')
	ax.legend()
	filename = 'VVR_vLPM_12184_byaq.png'
	if Task1.use_project_export_dir:
		plt.savefig(os.path.join(Directories.get_export_dir(),'plots',filename))
	else:
		plt.savefig(os.path.join('plots',filename))
